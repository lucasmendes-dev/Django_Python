...
SECRET_KEY = 'django-insecure-6vjs7b_oj5d69w-n4dekvgf9)bu!t_y#qos7#bil3#s_c#$c=h'
...
AUTH_USER_MODEL = "filme.Usuario"  #nomeapp.model
...
#constantes para configuração de autenticação de usuário para acessar pág.
